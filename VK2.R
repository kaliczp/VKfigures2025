...
mtext("Precipitation",2,2.6,at=5)
mtext("[mm]",2,1.8,at=5)
axis(2,c(0,5,10))
par(new=T)
#plot(na.omit(press.zoo[,1]),xlim=chron(-14187)+c(7,25),ylim=c(575,780),lwd=2,xaxt="n",yaxt="n",xlab="",ylab="")
...
mtext("Air pressure",2,2.6,at=749)
...
mtext("Air temperature",2,2.6,at=0)
mtext(expression(plain("[")*degree*plain("C]")),2,1.8,at=0)
axis(2,seq(-10,10,5))
text(-14179,5,"Max.",cex=.8)
text(-14179,-5,"Min.",cex=.8)
par(new=T)
plot(pressgw.zoo,xlim=chron(-14187)+c(7,25),lwd=2,xaxt="n",yaxt="n",xlab="",ylab="")
text(-14167,70,"Groundwater")
lines(rep(-14165,2),c(60,80))
lines(c(-14164.8,-14165.2),c(60,60))
lines(c(-14164.8,-14165.2),c(80,80))
text(-14164,70,"2 cm")
par(mgp=c(1.5,.2,0))
axis(1,at=-14180:-14163+.5,lab=7:24,tcl=0,cex.axis=0.8)
axis(1,at=-14180:-14162,lab=F)
mtext("March 1931",1,1.5)
#points(pressgw.zoo,col=2)
dev.off()
