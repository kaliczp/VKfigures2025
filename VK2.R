...
par(xaxs="i")#las=1,
plot(NULL,
     xlim=chron(-14187)+c(7,25), ylim=c(0,120),
     yaxs="i", xaxt="n", yaxt="n",
     xlab="",ylab="")
rect(index(press.csap) - 0.35, 0, index(press.csap) + 0.35,
     coredata(press.csap), col = "lightblue")
...
lines(press.max,lwd=2,lty="21", col = "red")
lines(press.min,lwd=2,lty="41", col = "red")
...
par(new=T)
plot(pressgw.zoo,xlim=chron(-14187)+c(7,25),lwd=2,xaxt="n",yaxt="n",xlab="",ylab="", col = "blue")
