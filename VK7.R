...
plot(NULL,
     ylim=ytg, yaxs="i",
     xlim=c(ISOdate(1955,8,25,0),ISOdate(1955,9,2,0)), xaxs="i",
     xlab="", ylab="",
     xaxt="n",yaxt="n",
     )
## Tengelyek
...
plot(NULL,
     ylim=ytg, yaxs="i",
     xlim=c(ISOdate(1956,7,29,0),ISOdate(1956,8,6,0)), xaxs="i",
     xlab="", ylab="",
     xaxt="n", yaxt="n"
     )
lines(fig113.z, lwd=2, col = "blue")
lines(ISOdate(1956,7:8,c(30,5),0),c(.385,.3632),col="grey")
text(ISOdate(1956,8,5,7,45),0.368,"Csap.",adj=0,cex=.7)
...
plot(NULL,
     ylim=ytg,yaxs="i",
     xlim=c(ISOdate(1955,7,25,0),ISOdate(1955,8,2,0)),xaxs="i",
     ylab="Patak vízállása [m]",xlab="",
     xaxt="n", yaxt="n")
